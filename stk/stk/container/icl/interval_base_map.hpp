...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_INTERVAL_BASE_MAP_HPP_JOFA_990223
#define STK_ICL_INTERVAL_BASE_MAP_HPP_JOFA_990223
...
#include <stk/container/icl/detail/notate.hpp> 
#include <stk/container/icl/detail/design_config.hpp>
#include <stk/container/icl/detail/on_absorbtion.hpp>
#include <stk/container/icl/detail/interval_map_algo.hpp>
#include <stk/container/icl/detail/exclusive_less_than.hpp>

#include <stk/container/icl/associative_interval_container.hpp>

#include <stk/container/icl/type_traits/is_interval_splitter.hpp>
#include <stk/container/icl/map.hpp>
...
<
    ...
    typename MapBuilder = detail::default_map_generator
>
...
public:
    ...
    typedef interval_base_map<SubType,DomainT,CodomainT,
                              Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder>
                              type;
    ...
    typedef typename icl::map<DomainT,CodomainT,
                              Traits,Compare,Combine,Section,Alloc,MapBuilder> atomized_type;
    ...
    typedef typename MapBuilder::template generate_type<interval_type,codomain_type, key_compare,allocator_type>::type ImplMapT;
...
#   endif // STK_ICL_NO_CXX11_RVALUE_REFERENCES
...
#pragma warning(disable:4127) // conditional expression is constant
    ...
    struct on_total_absorbable<Type, true, false>
    {
        ...
        { 
            ...
            if(boost::mpl::not_<is_interval_splitter<Type> >::value)
                icl::join(object);
        }
    };
...
//= Addition detail
//==============================================================================
template <class SubType, class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_INTERVAL(ICL_COMPARE) Interval, ICL_ALLOC Alloc, typename MapBuilder>
inline void interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder>
...
template <class SubType, class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_INTERVAL(ICL_COMPARE) Interval, ICL_ALLOC Alloc, typename MapBuilder>
    template<class Combiner>
inline typename interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder>::iterator
    interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder>
...
template <class SubType, class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_INTERVAL(ICL_COMPARE) Interval, ICL_ALLOC Alloc, typename MapBuilder>
inline SubType& interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder>
...
<
    class SubType,
    class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_INTERVAL(ICL_COMPARE)  Interval, ICL_ALLOC Alloc, typename MapBuilder
>
struct is_map<icl::interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder> >
{ 
    typedef is_map<icl::interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder> > type;
...
<
    ...
    class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_INTERVAL(ICL_COMPARE)  Interval, ICL_ALLOC Alloc, typename MapBuilder
>
struct has_inverse<icl::interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder> >
{ 
    typedef has_inverse<icl::interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder> > type;
...
<
    ...
    class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_INTERVAL(ICL_COMPARE)  Interval, ICL_ALLOC Alloc, typename MapBuilder
>
struct is_interval_container<icl::interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder> >
{ 
    typedef is_interval_container<icl::interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder> > type;
    BOOST_STATIC_CONSTANT(bool, value = true); 
};
...
<
    ...
    class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_INTERVAL(ICL_COMPARE)  Interval, ICL_ALLOC Alloc, typename MapBuilder
>
struct absorbs_identities<icl::interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder> >
{
    typedef absorbs_identities<icl::interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder> > type;
...
<
    ...
    class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_INTERVAL(ICL_COMPARE) Interval, ICL_ALLOC Alloc, typename MapBuilder
>
struct is_total<icl::interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder> >
{
    typedef is_total<icl::interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc,MapBuilder> > type;
