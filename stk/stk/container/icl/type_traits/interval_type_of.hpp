...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_INTERVAL_TYPE_OF_HPP_JOFA_100910
#define STK_ICL_TYPE_TRAITS_INTERVAL_TYPE_OF_HPP_JOFA_100910
...
namespace stk { namespace icl
{
    ...
    struct has_interval_type 
      : boost::mpl::bool_<detail::has_interval_type<Type>::value>
    {};
