...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_DOMAIN_TYPE_OF_HPP_JOFA_100902
#define STK_ICL_TYPE_TRAITS_DOMAIN_TYPE_OF_HPP_JOFA_100902
...
namespace stk { namespace icl
{
    ...
    struct has_domain_type 
      : boost::mpl::bool_<detail::has_domain_type<Type>::value>
    {};
