...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_SUCC_PRED_HPP_JOFA_080913
#define STK_ICL_TYPE_TRAITS_SUCC_PRED_HPP_JOFA_080913

#include <stk/container/icl/type_traits/is_increasing.hpp>
