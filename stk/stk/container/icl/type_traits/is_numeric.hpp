...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_IS_NUMERIC_HPP_JOFA_100322
#define STK_ICL_TYPE_TRAITS_IS_NUMERIC_HPP_JOFA_100322
...
template <class Type> struct is_numeric
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = 
        (boost::mpl::or_< is_std_numeric<Type>
...
struct is_non_floating_point
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = 
        (boost::mpl::not_< boost::is_floating_point<Type> >::value));
};
