...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_IS_INTERVAL_HPP_JOFA_100327
#define STK_ICL_TYPE_TRAITS_IS_INTERVAL_HPP_JOFA_100327
...
{ 
    ...
    BOOST_STATIC_CONSTANT(bool, 
        value = (boost::mpl::and_< has_static_bounds<Type>
...
{ 
    ...
    BOOST_STATIC_CONSTANT( bool, 
        value = (boost::mpl::and_< is_static_closed<Type>
                          , is_discrete<domain_type> >::value) ); 
};
...
{ 
    ...
    BOOST_STATIC_CONSTANT( bool, 
        value = (boost::mpl::and_< is_static_open<Type>
                          , is_discrete<domain_type> >::value) ); 
};
...
{ 
    ...
    typedef typename interval_traits<Type>::domain_type domain_type;
    BOOST_STATIC_CONSTANT(bool, 
        value = (boost::mpl::and_<is_static_right_open<Type>, is_continuous<domain_type> >::value)); 
};
...
{ 
    ...
    typedef typename interval_traits<Type>::domain_type domain_type;
    BOOST_STATIC_CONSTANT(bool, 
        value = (boost::mpl::and_<is_static_left_open<Type>, is_continuous<domain_type> >::value)); 
};
...
template <class Type> struct is_singelizable
{
    ...
    BOOST_STATIC_CONSTANT(bool, 
        value =
            (boost::mpl::or_< has_dynamic_bounds<Type>
