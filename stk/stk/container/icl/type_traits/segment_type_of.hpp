...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_SEGMENT_TYPE_OF_HPP_JOFA_100902
#define STK_ICL_TYPE_TRAITS_SEGMENT_TYPE_OF_HPP_JOFA_100902
...
namespace stk { namespace icl
{
    ...
    struct has_segment_type 
      : boost::mpl::bool_<detail::has_segment_type<Type>::value>
    {};
