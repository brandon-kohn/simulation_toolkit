...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_IS_COMBINABLE_HPP_JOFA_090115
#define STK_ICL_IS_COMBINABLE_HPP_JOFA_090115
...
#include <stk/container/icl/type_traits/is_concept_equivalent.hpp>
...
struct is_codomain_type_equal
{
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        (boost::mpl::and_<is_key_compare_equal<LeftT, RightT>, 
...
struct is_inter_combinable
{
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        (boost::mpl::or_<is_intra_combinable<LeftT,RightT>, 
...
struct is_intra_derivative
{
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        (boost::mpl::or_
        <     
            boost::mpl::and_<is_interval_set<Type>, 
                      is_interval_set_derivative<Type, AssociateT> >
          , boost::mpl::and_<is_interval_map<Type>, 
...
struct combines_right_to_interval_container
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = 
        (boost::mpl::or_<combines_right_to_interval_set<GuideT, IntervalContainerT>,
...
template<class Type>struct segmentational_fineness
{
    ...
    static const int value = 
        boost::mpl::if_<is_interval_container<Type>, 
                        known_fineness<Type>,
...
struct is_coarser_interval_set_companion
{
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        ...
        <
         ...
         , boost::mpl::bool_<(  segmentational_fineness<GuideT>::value 
...
{ 
    ...
    static const int value =
        boost::mpl::and_<  is_interval_set<GuideT>
...
{ 
    ...
    static const int value =
        boost::mpl::and_<  is_interval_map<GuideT>
...
{ 
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        (boost::mpl::or_<is_binary_interval_set_combinable<GuideT, CompanionT>,
...
{ 
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        (boost::mpl::and_
        <     is_interval_map<GuideT>
            , boost::mpl::or_<  is_coarser_interval_map_companion<GuideT, CompanionT>
                       ,         is_interval_set_companion<GuideT, CompanionT> > 
        >::value)
        );
};
