...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_IS_KEY_CONTAINER_OF_HPP_JOFA_100829
#define STK_ICL_TYPE_TRAITS_IS_KEY_CONTAINER_OF_HPP_JOFA_100829
...
namespace stk { namespace icl
{
    ...
    struct has_key_object_type 
      : boost::mpl::bool_<detail::has_key_object_type<Type>::value>
    {};
    ...
    struct key_container_type_of
    {
        typedef typename 
            ...
            , boost::mpl::or_<is_set<Type>, is_map<Type> >::value
            >::type type;
    };
    ...
    struct is_key_container_of // set is_key_container_of (set or map)
    {
        ...
        BOOST_STATIC_CONSTANT(bool, value =
            (boost::mpl::or_< is_strict_key_container_of<KeyT, ObjectT> 
                     , boost::mpl::and_< boost::mpl::or_<is_set<ObjectT>, is_map<ObjectT> >
