...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_CODOMAIN_TYPE_OF_HPP_JOFA_100829
#define STK_ICL_TYPE_TRAITS_CODOMAIN_TYPE_OF_HPP_JOFA_100829
...
namespace stk { namespace icl
{
    ...
    struct has_codomain_type 
      : boost::mpl::bool_<detail::has_codomain_type<Type>::value>
    {};
