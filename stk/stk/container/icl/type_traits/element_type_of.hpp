...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_ELEMENT_TYPE_OF_HPP_JOFA_100902
#define STK_ICL_TYPE_TRAITS_ELEMENT_TYPE_OF_HPP_JOFA_100902
...
namespace stk { namespace icl
{
    ...
    struct has_element_type 
      : boost::mpl::bool_<detail::has_element_type<Type>::value>
    {};
    ...
    struct has_value_type 
      : boost::mpl::bool_<detail::has_value_type<Type>::value>
    {};
    ...
    template <class Type>
    struct has_key_type 
      : boost::mpl::bool_<detail::has_key_type<Type>::value>
    {};
