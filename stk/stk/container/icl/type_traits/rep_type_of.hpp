...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_REP_TYPE_OF_HPP_JOFA_110329
#define STK_ICL_TYPE_TRAITS_REP_TYPE_OF_HPP_JOFA_110329
...
namespace stk { namespace icl
{
    ...
    template <class Type>
    struct has_rep_type
      : boost::mpl::bool_<detail::has_rep<Type>::value>
    {};
      ...
      : boost::mpl::bool_<detail::has_rep<Type>::value>
    {
        ...
        BOOST_STATIC_CONSTANT(bool,
            value = (boost::mpl::and_< has_rep_type<Type>
