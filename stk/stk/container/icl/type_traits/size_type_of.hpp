...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_SIZE_TYPE_OF_HPP_JOFA_080911
#define STK_ICL_TYPE_TRAITS_SIZE_TYPE_OF_HPP_JOFA_080911
...
namespace stk { namespace icl
{
    ...
    struct has_size_type 
      : boost::mpl::bool_<detail::has_size_type<Type>::value>
    {};
