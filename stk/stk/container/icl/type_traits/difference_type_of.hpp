...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_DIFFERENCE_TYPE_OF_HPP_JOFA_080911
#define STK_ICL_TYPE_TRAITS_DIFFERENCE_TYPE_OF_HPP_JOFA_080911
...
#include <stk/container/icl/type_traits/no_type.hpp>
...
namespace stk { namespace icl
{
    ...
    struct has_difference_type 
      : boost::mpl::bool_<detail::has_difference_type<Type>::value>
    {};
    ...
    struct is_subtraction_closed
    {
        ...
        BOOST_STATIC_CONSTANT(bool, 
            value = (boost::mpl::or_< is_numeric<Type>
                             , boost::mpl::and_< has_rep_type<Type>
                                        , boost::mpl::not_<has_difference_type<Type> > 
                                        >
                             >::value)
            );
    };
    ...
    struct has_difference
    {
        ...
        BOOST_STATIC_CONSTANT(bool, 
            value = (boost::mpl::or_< is_subtraction_closed<Type>
                             , boost::is_pointer<Type> 
