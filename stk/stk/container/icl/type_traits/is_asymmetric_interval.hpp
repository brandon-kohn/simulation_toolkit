...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_TYPE_TRAITS_IS_ASYMMETRIC_INTERVAL_HPP_JOFA_100327
#define STK_ICL_TYPE_TRAITS_IS_ASYMMETRIC_INTERVAL_HPP_JOFA_100327
...
{ 
    ...
    BOOST_STATIC_CONSTANT(bool,
            value = (boost::mpl::and_<
                        is_asymmetric_interval<Type>
                    ,   boost::mpl::not_<is_continuous<typename domain_type_of<interval_traits<Type> >::type> >
                    >::value)
                );
};
