...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_INTERVAL_BASE_SET_H_JOFA_990223
#define STK_ICL_INTERVAL_BASE_SET_H_JOFA_990223
...
#include <stk/container/icl/type_traits/interval_type_default.hpp>
#include <stk/container/icl/interval.hpp>
#include <stk/container/icl/type_traits/infinity.hpp>
#include <stk/container/icl/type_traits/is_interval_joiner.hpp>
#include <stk/container/icl/type_traits/is_interval_separator.hpp>
...
#include <stk/container/icl/right_open_interval.hpp>
#include <stk/container/icl/continuous_interval.hpp>
#include <stk/container/icl/detail/notate.hpp>
#include <stk/container/icl/detail/element_iterator.hpp>
namespace stk {namespace icl
{
    namespace detail
    {
        struct default_set_generator
        {
            template <typename Key, typename Compare = std::less<Key>, typename Alloc = std::allocator<Key> >
            struct generate_type
            {
                typedef typename ICL_IMPL_SPACE::set<Key,Compare,Alloc> type;
            };
...
<
    ...
    typename SetBuilder  = detail::default_set_generator
>
...
public:
    ...
    typedef typename SetBuilder::template generate_type<DomainT, domain_compare, Alloc<DomainT> >::type atomized_type;
    ...
    typedef typename SetBuilder::template generate_type<interval_type,key_compare,allocator_type>::type ImplSetT;
    ...
    typedef stk::icl::element_iterator<iterator> element_iterator;
    /// element const iterator: Depreciated, see documentation.
    typedef stk::icl::element_iterator<const_iterator> element_const_iterator;
    /// element reverse iterator: Depreciated, see documentation.
    typedef stk::icl::element_iterator<reverse_iterator> element_reverse_iterator;
    /// element const reverse iterator: Depreciated, see documentation.
    typedef stk::icl::element_iterator<const_reverse_iterator> element_const_reverse_iterator;
...
template <class SubType, class DomainT, ICL_COMPARE Compare, ICL_INTERVAL(ICL_COMPARE) Interval, ICL_ALLOC Alloc, typename SetBuilder>
inline void interval_base_set<SubType,DomainT,Compare,Interval,Alloc,SetBuilder>
...
//==============================================================================
template <class SubType, class DomainT, ICL_COMPARE Compare, ICL_INTERVAL(ICL_COMPARE) Interval, ICL_ALLOC Alloc, typename SetBuilder>
inline typename interval_base_set<SubType,DomainT,Compare,Interval,Alloc,SetBuilder>::iterator
    interval_base_set<SubType,DomainT,Compare,Interval,Alloc,SetBuilder>
    ::_add(const segment_type& addend)
{
    typedef typename interval_base_set<SubType,DomainT,Compare,Interval,Alloc,SetBuilder>::iterator iterator;
    ...
    {
        iterator last_ = boost::prior(this->_set.upper_bound(addend));
...
//==============================================================================
template <class SubType, class DomainT, ICL_COMPARE Compare, ICL_INTERVAL(ICL_COMPARE) Interval, ICL_ALLOC Alloc, typename SetBuilder>
inline SubType& interval_base_set<SubType,DomainT,Compare,Interval,Alloc,SetBuilder>
...
template<class SubType,
         class DomainT, ICL_COMPARE Compare, ICL_INTERVAL(ICL_COMPARE)  Interval, ICL_ALLOC Alloc, typename SetBuilder>
struct is_set<icl::interval_base_set<SubType,DomainT,Compare,Interval,Alloc,SetBuilder> >
{
    typedef is_set<icl::interval_base_set<SubType,DomainT,Compare,Interval,Alloc,SetBuilder> > type;
    BOOST_STATIC_CONSTANT(bool, value = true);
};

template<class SubType,
         class DomainT, ICL_COMPARE Compare, ICL_INTERVAL(ICL_COMPARE)  Interval, ICL_ALLOC Alloc, typename SetBuilder>
struct is_interval_container<icl::interval_base_set<SubType,DomainT,Compare,Interval,Alloc,SetBuilder> >
{
    typedef is_interval_container<icl::interval_base_set<SubType,DomainT,Compare,Interval,Alloc,SetBuilder> > type;
    BOOST_STATIC_CONSTANT(bool, value = true);
};
