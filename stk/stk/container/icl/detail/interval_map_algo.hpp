...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_INTERVAL_MAP_ALGO_HPP_JOFA_100730
#define STK_ICL_INTERVAL_MAP_ALGO_HPP_JOFA_100730
...
//- domain_type ----------------------------------------------------------------
template<class IntervalMapT>
typename boost::enable_if<boost::mpl::not_<is_total<IntervalMapT> >, bool>::type
...
template<class IntervalMapT>
typename boost::enable_if<is_total<IntervalMapT>, bool>::type
...
typename boost::enable_if<boost::mpl::and_<boost::mpl::not_<is_total<IntervalMapT> >
...
template<class IntervalMapT, class IntervalSetT>
typename boost::enable_if<boost::mpl::and_<is_total<IntervalMapT>
                            ,is_interval_set<IntervalSetT> >, bool>::type
