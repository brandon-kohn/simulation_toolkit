...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_DETAIL_MAPPED_REFERENCE_HPP_JOFA_091108
#define STK_ICL_DETAIL_MAPPED_REFERENCE_HPP_JOFA_091108
...
public:
    ...
    typedef typename 
       boost::mpl::if_<boost::is_const<second_type>, 
                       second_type&, 
    ...
    typename boost::enable_if<is_mapped_reference_or_combinable<Comparand>, bool>::type
...
inline typename boost::enable_if<is_mapped_reference_combinable<StdPairT>, bool>::type
...
#endif // STK_ICL_DETAIL_MAPPED_REFERENCE_HPP_JOFA_091108
