...
+-----------------------------------------------------------------------------*/
#ifndef  STK_ICL_DESIGN_CONFIG_HPP_JOFA_090214
#define  STK_ICL_DESIGN_CONFIG_HPP_JOFA_090214
...
// STK_ICL_USE_STATIC_BOUNDED_INTERVALS should be defined in the application
// before other includes from the ITL
//#define STK_ICL_USE_STATIC_BOUNDED_INTERVALS
// If STK_ICL_USE_STATIC_BOUNDED_INTERVALS is NOT defined, ITL uses intervals
...
#endif // STK_ICL_DESIGN_CONFIG_HPP_JOFA_090214
