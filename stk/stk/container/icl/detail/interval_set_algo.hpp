...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_INTERVAL_SET_ALGO_HPP_JOFA_081005
#define STK_ICL_INTERVAL_SET_ALGO_HPP_JOFA_081005

#include <boost/next_prior.hpp>
#include <stk/container/icl/detail/notate.hpp>
#include <stk/container/icl/detail/relation_state.hpp>
...
#include <stk/container/icl/concept/set_value.hpp>
#include <stk/container/icl/concept/map_value.hpp>
#include <stk/container/icl/interval_combining_style.hpp>
#include <stk/container/icl/detail/element_comparer.hpp>
#include <stk/container/icl/detail/interval_subset_comparer.hpp>
#include <stk/container/icl/detail/associated_value.hpp>
...
template<class LeftT, class RightT>
typename boost::enable_if<boost::mpl::and_<is_concept_combinable<is_interval_set, is_interval_map, LeftT, RightT>, 
                             is_total<RightT> >,
                   bool>::type
...
template<class LeftT, class RightT>
typename boost::enable_if<boost::mpl::and_<is_concept_combinable<is_interval_set, is_interval_map, LeftT, RightT>, 
                             boost::mpl::not_<is_total<RightT> > >,
                   bool>::type
...
template<class LeftT, class RightT>
typename boost::enable_if<is_concept_combinable<is_interval_map, is_interval_map, LeftT, RightT>, 
                   bool>::type
within(const LeftT& sub, const RightT& super)
{
    int result =
...
template<class LeftT, class RightT>
typename boost::enable_if<is_concept_combinable<is_interval_set, is_interval_set, LeftT, RightT>, 
                   bool>::type
within(const LeftT& sub, const RightT& super)
{
    int result =
...
template<class LeftT, class RightT>
typename boost::enable_if<boost::mpl::and_<is_concept_combinable<is_interval_map, is_interval_set, LeftT, RightT>, 
                             is_total<LeftT> >,
                   bool>::type
