...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_SUBSET_COMPARER_HPP_JOFA_090202
#define STK_ICL_SUBSET_COMPARER_HPP_JOFA_090202
...
#include <stk/container/icl/concept/interval_set_value.hpp>
...
public:
    ...
    BOOST_STATIC_CONSTANT(bool, 
        _compare_codomain = (boost::mpl::and_<is_map<LeftT>, is_map<RightT> >::value)); 
