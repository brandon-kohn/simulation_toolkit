...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_DETAIL_ELEMENT_ITERATOR_HPP_JOFA_091104
#define STK_ICL_DETAIL_ELEMENT_ITERATOR_HPP_JOFA_091104

#include <boost/mpl/if.hpp>
#include <boost/iterator/iterator_facade.hpp>
#include <boost/config/warning_disable.hpp>
#include <stk/container/icl/type_traits/succ_pred.hpp>
#include <stk/container/icl/detail/mapped_reference.hpp>
...
public:
    ...
    element_iterator
        ...
        , typename boost::enable_if<boost::is_convertible<SaltatorT*,SegmentIteratorT*>, enabler>::type = enabler())
...
#endif // STK_ICL_DETAIL_ELEMENT_ITERATOR_HPP_JOFA_091104
