...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_MAP_HPP_JOFA_070519
#define STK_ICL_MAP_HPP_JOFA_070519
...
#include <stk/container/icl/detail/concept_check.hpp>
#include <stk/container/icl/detail/on_absorbtion.hpp>
#include <stk/container/icl/type_traits/is_map.hpp>
#include <stk/container/icl/type_traits/absorbs_identities.hpp>
#include <stk/container/icl/type_traits/is_total.hpp>
...
#include <stk/container/icl/type_traits/to_string.hpp>
...
inline std::string type_to_string<total_enricher>::apply() { return "e^0"; }
    ...
    namespace detail
    {
        struct default_map_generator
        {
            ...
            {
                typedef typename ICL_IMPL_SPACE::map<Key,Data,Compare,Alloc> type;
            };
...
>
class map: private MapBuilder::template generate_type<DomainT, CodomainT, ICL_COMPARE_DOMAIN(Compare,DomainT),
                                       Alloc<std::pair<const DomainT, CodomainT> > >::type
{
public:
    typedef Alloc<typename std::pair<const DomainT, CodomainT> >  allocator_type;

    typedef typename icl::map<DomainT,CodomainT,Traits, Compare,Combine,Section,Alloc,MapBuilder> type;
    typedef typename MapBuilder::generate_type<DomainT, CodomainT, ICL_COMPARE_DOMAIN(Compare,DomainT),
                                         allocator_type>::type   base_type;
...
public:
    ...
    BOOST_STATIC_CONSTANT(bool,
        total_invertible = (boost::mpl::and_<is_total<type>, has_inverse<codomain_type> >::value));
...
//= Addition<ElementMap>
//==============================================================================
template <class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_ALLOC Alloc, typename MapBuilder>
    template <class Combiner>
map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder>&
    map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder>
...
template <class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_ALLOC Alloc,typename MapBuilder>
    template <class Combiner>
typename map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder>::iterator
    map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder>
...
template <class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_ALLOC Alloc, typename MapBuilder>
    template <class Combiner>
map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder>&
    map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder>::_subtract(const value_type& minuend)
{
    typedef typename on_absorbtion
        <type,Combiner,absorbs_identities<type>::value>::type on_absorbtion_;
...
//-----------------------------------------------------------------------------
template <class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_ALLOC Alloc, typename MapBuilder>
struct is_map<icl::map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder> >
{
    typedef is_map<icl::map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder> > type;
    BOOST_STATIC_CONSTANT(bool, value = true);
};

template <class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_ALLOC Alloc, typename MapBuilder>
struct has_inverse<icl::map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder> >
{
    typedef has_inverse<icl::map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder> > type;
    BOOST_STATIC_CONSTANT(bool, value = (has_inverse<CodomainT>::value));
};

template <class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_ALLOC Alloc, typename MapBuilder>
struct absorbs_identities<icl::map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder> >
{
...
template <class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_ALLOC Alloc, typename MapBuilder>
struct is_total<icl::map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder> >
{
...
template <class DomainT, class CodomainT, class Traits, ICL_COMPARE Compare, ICL_COMBINE Combine, ICL_SECTION Section, ICL_ALLOC Alloc, typename MapBuilder>
struct type_to_string<icl::map<DomainT,CodomainT,Traits,Compare,Combine,Section,Alloc,MapBuilder> >
{
...
#endif // STK_ICL_MAP_HPP_JOFA_070519
