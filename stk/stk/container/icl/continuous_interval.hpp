...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_CONTINUOUS_INTERVAL_HPP_JOFA_100327
#define STK_ICL_CONTINUOUS_INTERVAL_HPP_JOFA_100327
...
#include <stk/container/icl/concept/container.hpp>
#include <stk/container/icl/type_traits/value_size.hpp>
...
#include <stk/container/icl/interval_bounds.hpp>
...
//==============================================================================
template<class DomainT, ICL_COMPARE Compare>
struct dynamic_interval_traits<stk::icl::continuous_interval<DomainT,Compare> >
{
    typedef dynamic_interval_traits type;
    typedef stk::icl::continuous_interval<DomainT,Compare> interval_type;
    typedef DomainT domain_type;
    typedef ICL_COMPARE_DOMAIN(Compare,DomainT) domain_compare;
