...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_CONCEPT_INTERVAL_BOUNDS_HPP_JOFA_100927
#define STK_ICL_CONCEPT_INTERVAL_BOUNDS_HPP_JOFA_100927
...
template <class Type>
inline typename boost::enable_if<is_discrete<Type>, Type>::type
