...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_CONCEPT_INTERVAL_MAP_HPP_JOFA_100920
#define STK_ICL_CONCEPT_INTERVAL_MAP_HPP_JOFA_100920

#include <stk/container/icl/type_traits/element_type_of.hpp>
#include <stk/container/icl/type_traits/segment_type_of.hpp>
...
#include <stk/container/icl/concept/joinable.hpp>
namespace stk { namespace icl
{

template<class Type>
inline typename boost::enable_if<is_interval_map<Type>, typename Type::segment_type>::type
...
//------------------------------------------------------------------------------
template<class Type>
typename boost::enable_if<is_interval_map<Type>, bool>::type
...
typename boost::enable_if<is_concept_compatible<is_interval_map, Type, CoType>, bool>::type
...
//------------------------------------------------------------------------------
template<class Type, class CoType>
typename boost::enable_if< boost::mpl::and_< is_interval_map<Type>
                             , is_total<Type> 
...
typename boost::enable_if< boost::mpl::and_< is_concept_combinable<is_interval_map, is_interval_set, Type, KeyT>
                             , boost::mpl::not_<is_total<Type> > >
            , bool>::type
...
//------------------------------------------------------------------------------
template<class Type>
typename boost::enable_if<is_interval_map<Type>, Type>::type&
...
//------------------------------------------------------------------------------
template<class Type>
typename boost::enable_if<is_interval_map<Type>, typename Type::iterator >::type
...
template<class Type>
inline typename boost::enable_if<is_interval_map<Type>, Type>::type&
...
//------------------------------------------------------------------------------
template<class Type>
typename boost::enable_if<is_interval_map<Type>, void>::type
...
typename boost::enable_if
<
    boost::mpl::and_< boost::mpl::not_<is_total<Type> >
             , is_concept_compatible<is_interval_map, Type, MapT> >
  , void
>::type
add_intersection(Type& section, const Type& object, const MapT& operand)
...
typename boost::enable_if<is_concept_combinable<is_interval_map, is_interval_set, Type, KeySetT>, void>::type
...
//------------------------------------------------------------------------------
template<class Type, class OperandT>
typename boost::enable_if< boost::mpl::and_< is_total<Type>
...
template<class Type, class OperandT>
typename boost::enable_if< boost::mpl::and_< is_total<Type>
                             , boost::mpl::not_<absorbs_identities<Type> >
                             , is_concept_compatible<is_interval_map, 
                                                     Type, OperandT >
                             >
                  , Type>::type&
...
//------------------------------------------------------------------------------
template<class Type, class OperandT>
typename boost::enable_if< boost::mpl::and_< boost::mpl::not_<is_total<Type> > 
                             , is_concept_compatible<is_interval_map, 
                                                     Type, OperandT >
                             >
                  , Type>::type&
...
typename boost::enable_if<is_concept_combinable<is_interval_set, is_interval_map, 
                                         SetT, Type>, SetT>::type&
...
typename boost::enable_if<is_interval_map<MapT>, MapT>::type&
...
template<class MapT, class Predicate>
inline typename boost::enable_if<is_interval_map<MapT>, MapT>::type&
...
template<class Type>
typename boost::enable_if<boost::mpl::and_< is_interval_map<Type>
                            , boost::mpl::not_<absorbs_identities<Type> > >, Type>::type&
absorb_identities(Type& object)
{
    typedef typename Type::segment_type segment_type;
...
typename boost::enable_if<is_interval_map<Type>, 
