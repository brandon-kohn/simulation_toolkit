...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_CONCEPT_INTERVAL_ASSOCIATOR_HPP_JOFA_100920
#define STK_ICL_CONCEPT_INTERVAL_ASSOCIATOR_HPP_JOFA_100920

#include <boost/range/iterator_range.hpp>
#include <stk/container/icl/type_traits/domain_type_of.hpp>
#include <stk/container/icl/type_traits/interval_type_of.hpp>
#include <stk/container/icl/type_traits/is_combinable.hpp>
#include <stk/container/icl/detail/set_algo.hpp>
#include <stk/container/icl/detail/map_algo.hpp>
#include <stk/container/icl/detail/interval_set_algo.hpp>
...
typename boost::enable_if<is_interval_container<SuperT>, bool>::type 
...
//==============================================================================
template<class Type>
inline typename boost::enable_if<is_interval_container<Type>, bool>::type
...
typename boost::enable_if<is_intra_combinable<LeftT, RightT>, bool>::type
...
//------------------------------------------------------------------------------
template<class LeftT, class RightT>
typename boost::enable_if<is_inter_combinable<LeftT, RightT>, int>::type
...
//------------------------------------------------------------------------------
template<class LeftT, class RightT>
typename boost::enable_if< is_concept_compatible<is_interval_map, LeftT, RightT>,
                    bool >::type
...
//==============================================================================
template<class Type> 
typename boost::enable_if<is_interval_container<Type>, std::size_t>::type
...
typename boost::enable_if
< boost::mpl::and_< is_interval_container<Type>
           , boost::mpl::not_<is_discrete<typename Type::domain_type> > >
, typename Type::size_type
>::type
cardinality(const Type& object)
{
...
template<class Type>
inline typename boost::enable_if<is_interval_container<Type>, typename Type::size_type>::type
...
template<class Type>
typename boost::enable_if<is_interval_container<Type>, typename Type::difference_type>::type
...
template<class Type>
typename boost::enable_if< is_interval_container<Type> 
...
typename boost::enable_if<is_intra_derivative<Type, OperandT>, Type>::type&
...
template<class Type, class OperandT>
typename boost::enable_if<is_intra_combinable<Type, OperandT>, Type>::type&
operator += (Type& object, const OperandT& operand)
{
...
#ifdef STK_ICL_NO_CXX11_RVALUE_REFERENCES
//------------------------------------------------------------------------------
...
template<class Type, class OperandT>
typename boost::enable_if<is_binary_intra_combinable<Type, OperandT>, Type>::type
operator + (Type object, const OperandT& operand)
{
    return object += operand; 
}

#else //STK_ICL_NO_CXX11_RVALUE_REFERENCES
...
/** \par \b Requires: \c object and \c operand are addable.
    ...
    \c Type \c object compared to inplace \c operator \c += */
template<class Type>
typename boost::enable_if<is_interval_container<Type>, Type>::type
...
*/
template<class Type, class OperandT>
typename boost::enable_if<is_right_intra_combinable<Type, OperandT>, Type>::type&
operator |= (Type& object, const OperandT& operand)
{ 
    return object += operand; 
}
...
//------------------------------------------------------------------------------
template<class Type, class OperandT>
typename boost::enable_if<combines_right_to_interval_container<Type, OperandT>,
                   Type>::type&
...
*/
template<class Type, class OperandT>
typename boost::enable_if<is_concept_compatible<is_interval_map, Type, OperandT>, 
                   Type>::type& 
operator -=(Type& object, const OperandT& operand)
{
    ICL_const_FORALL(typename OperandT, elem_, operand) 
...
//------------------------------------------------------------------------------
template<class Type, class OperandT>
typename boost::enable_if<is_cross_derivative<Type, OperandT>, Type>::type&
operator -= (Type& object, const OperandT& operand)
{ 
...
typename boost::enable_if<combines_right_to_interval_set<Type, IntervalSetT>,
                   Type>::type&
...
//------------------------------------------------------------------------------
template<class Type, class OperandT>
typename boost::enable_if<is_right_inter_combinable<Type, OperandT>, Type>::type
operator - (Type object, const OperandT& operand)
{
    return object -= operand; 
}
...
//------------------------------------------------------------------------------
template<class Type, class OperandT>
typename boost::enable_if<boost::mpl::and_<is_interval_set<Type>, 
...
//------------------------------------------------------------------------------
template<class Type, class OperandT>
typename boost::enable_if<is_binary_inter_combinable<Type, OperandT>, Type>::type
operator & (Type object, const OperandT& operand)
{
    return object &= operand; 
}
...
typename boost::enable_if<boost::mpl::and_< is_interval_container<Type>
...
template<class LeftT, class RightT>
typename boost::enable_if< boost::mpl::and_< is_intra_combinable<LeftT, RightT> 
                             , boost::mpl::or_<is_total<LeftT>, is_total<RightT> > >
                  , bool>::type
...
template<class LeftT, class RightT>
typename boost::enable_if< boost::mpl::and_< is_intra_combinable<LeftT, RightT> 
                             , boost::mpl::not_<boost::mpl::or_< is_total<LeftT>
                                                 , is_total<RightT> > > >
                  , bool>::type
...
template<class LeftT, class RightT>
typename boost::enable_if<is_cross_combinable<LeftT, RightT>, bool>::type
intersects(const LeftT& left, const RightT& right)
{
    typedef typename RightT::const_iterator const_iterator;
    LeftT intersection;
...
template<class LeftT, class RightT>
typename boost::enable_if<is_inter_combinable<LeftT, RightT>, bool>::type
...
typename boost::enable_if<is_inter_derivative<Type, AssociateT>, bool>::type
...
typename boost::enable_if
<boost::mpl::and_< is_interval_container<Type> 
          , boost::mpl::not_<is_continuous_interval<typename Type::interval_type> > >,
...
<boost::mpl::and_< is_interval_container<Type>
          , boost::mpl::not_<is_continuous_interval<typename Type::interval_type> > >,
boost::iterator_range<typename Type::element_iterator> >::type
...
<boost::mpl::and_< is_interval_container<Type>
          , boost::mpl::not_<is_continuous_interval<typename Type::interval_type> > >,
boost::iterator_range<typename Type::element_const_iterator> >::type
