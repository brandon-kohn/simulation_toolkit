...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_CONCEPT_ELEMENT_MAP_HPP_JOFA_100921
#define STK_ICL_CONCEPT_ELEMENT_MAP_HPP_JOFA_100921
...
#include <stk/container/icl/type_traits/is_associative_element_container.hpp>
#include <stk/container/icl/type_traits/is_combinable.hpp>

#include <stk/container/icl/concept/map_value.hpp>
...
typename boost::enable_if<is_associative_element_container<Type>, Type>::type&
...
template<class Type>
typename boost::enable_if<is_element_map<Type>, bool>::type
...
template<class Type>
inline typename boost::enable_if<is_element_map<Type>, bool>::type
...
template <class Type>
typename boost::enable_if<is_element_map<Type>, Type>::type&
...
template <class Type>
typename boost::enable_if<is_element_map<Type>, typename Type::iterator>::type
...
//------------------------------------------------------------------------------
template <class Type>
typename boost::enable_if<is_element_map<Type>, typename Type::size_type>::type
...
//------------------------------------------------------------------------------
template <class Type>
inline typename boost::enable_if<is_element_map<Type>, Type>::type&
...
//==============================================================================
template<class Type>
inline typename boost::enable_if<is_element_map<Type>, void>::type
...
template<class Type>
inline typename boost::enable_if<boost::mpl::and_<is_element_map<Type>, is_total<Type> >, Type>::type&
...
template<class Type>
inline typename boost::enable_if<boost::mpl::and_<is_element_map<Type>, boost::mpl::not_<is_total<Type> > >, Type>::type&
operator &=(Type& object, const typename Type::element_type& operand)
{
    Type section;
...
inline typename boost::enable_if< boost::mpl::and_< is_element_map<Type>
                                    , is_total<Type>      > 
                         , bool>::type
...
//==============================================================================
template<class Type>
inline typename boost::enable_if<is_element_map<Type>, 
...
inline typename boost::enable_if<is_element_map<Type>, std::basic_ostream<CharType, CharTraits> >::type&
