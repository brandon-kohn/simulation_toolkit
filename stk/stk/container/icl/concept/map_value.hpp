...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_CONCEPT_MAP_VALUE_HPP_JOFA_100924
#define STK_ICL_CONCEPT_MAP_VALUE_HPP_JOFA_100924
...
inline typename boost::enable_if<is_map<Type>, const typename Type::key_type>::type&
...
template<class Type, class Iterator>
inline typename boost::enable_if<is_map<Type>, const typename Type::codomain_type>::type&
...
template<class Type>
inline typename boost::enable_if<is_map<Type>, typename Type::value_type>::type
