...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_CONCEPT_SET_VALUE_HPP_JOFA_100924
#define STK_ICL_CONCEPT_SET_VALUE_HPP_JOFA_100924
...
inline typename boost::enable_if<is_set<Type>, const typename Type::key_type>::type&
...
template<class Type>
inline typename boost::enable_if<is_set<Type>, typename Type::value_type>::type
