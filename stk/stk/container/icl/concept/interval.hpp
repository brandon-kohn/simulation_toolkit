...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_CONCEPT_INTERVAL_HPP_JOFA_100323
#define STK_ICL_CONCEPT_INTERVAL_HPP_JOFA_100323
...
#include <stk/container/icl/type_traits/unit_element.hpp>
#include <stk/container/icl/type_traits/identity_element.hpp>
#include <stk/container/icl/type_traits/infinity.hpp>
#include <stk/container/icl/type_traits/succ_pred.hpp>
#include <stk/container/icl/type_traits/is_numeric.hpp>
#include <stk/container/icl/type_traits/is_discrete.hpp>
#include <stk/container/icl/type_traits/is_continuous.hpp>
#include <stk/container/icl/type_traits/is_asymmetric_interval.hpp>
#include <stk/container/icl/type_traits/is_discrete_interval.hpp>
#include <stk/container/icl/type_traits/is_continuous_interval.hpp>

#include <stk/container/icl/concept/interval_bounds.hpp>
#include <stk/container/icl/interval_traits.hpp>
#include <stk/container/icl/dynamic_interval_traits.hpp>
...
template<class Type>
inline typename boost::enable_if< is_interval<Type>
...
<
    boost::mpl::and_< is_static_right_open<Type>
...
typename boost::enable_if
<
    boost::mpl::and_< is_static_left_open<Type>
             , is_discrete<typename interval_traits<Type>::domain_type> >
  , Type
>::type
singleton(const typename interval_traits<Type>::domain_type& value)
...
typename boost::enable_if
<
    boost::mpl::and_< is_static_open<Type>
             , is_discrete<typename interval_traits<Type>::domain_type> >
  , Type
>::type
unit_trail(const typename interval_traits<Type>::domain_type& value)
...
typename boost::enable_if
<
    boost::mpl::and_< is_static_closed<Type>
             , is_discrete<typename interval_traits<Type>::domain_type> >
  , Type
>::type
unit_trail(const typename interval_traits<Type>::domain_type& value)
...
template<class Type>
typename boost::enable_if<is_interval<Type>, Type>::type
...
//==============================================================================
template<class Type>
typename boost::enable_if<is_static_right_open<Type>, Type>::type
...
template<class Type>
typename boost::enable_if<is_static_left_open<Type>, Type>::type
hull(const typename interval_traits<Type>::domain_type& left,
     const typename interval_traits<Type>::domain_type& right)
{
    typedef typename interval_traits<Type>::domain_type    domain_type;
...
template<class Type>
inline typename
boost::enable_if< boost::mpl::or_<is_static_right_open<Type>, is_static_closed<Type> >
         , typename interval_traits<Type>::domain_type>::type
...
template<class Type>
inline typename
boost::enable_if< boost::mpl::and_< boost::mpl::or_<is_static_left_open<Type>, is_static_open<Type> >
                    , is_discrete<typename interval_traits<Type>::domain_type> >
         , typename interval_traits<Type>::domain_type>::type
first(const Type& object)
{
...
template<class Type>
inline typename
boost::enable_if< boost::mpl::or_<is_static_left_open<Type>, is_static_closed<Type> >
         , typename interval_traits<Type>::domain_type>::type
...
template<class Type>
inline typename
boost::enable_if< boost::mpl::and_< boost::mpl::or_<is_static_right_open<Type>, is_static_open<Type> >
                    , is_discrete<typename interval_traits<Type>::domain_type>  >
         , typename interval_traits<Type>::domain_type>::type
last(const Type& object)
{
...
template<class Type>
inline typename
boost::enable_if< boost::mpl::and_< boost::mpl::or_<is_static_left_open<Type>, is_static_closed<Type> >
                    , is_discrete<typename interval_traits<Type>::domain_type>  >
         , typename interval_traits<Type>::domain_type>::type
...
//- bounds ---------------------------------------------------------------------
template<class Type>
inline typename boost::enable_if<has_dynamic_bounds<Type>, interval_bounds>::type
...
template<class Type>
inline typename boost::enable_if<has_static_bounds<Type>, interval_bounds>::type
bounds(const Type&)
{
...
template<class Type>
inline typename 
boost::enable_if<has_symmetric_bounds<Type>, bool>::type
exclusive_less(const Type& left, const Type& right)
{
    return icl::is_empty(left) || icl::is_empty(right)
        || domain_less<Type>(last(left), first(right));
...
template<class Type>
typename 
boost::enable_if< boost::mpl::and_< is_interval<Type>
...
template<class Type>
typename
    boost::enable_if< boost::mpl::or_< is_static_left_open<Type>
                       , is_static_open<Type>    >, std::string>::type
left_bracket(const Type&) { return "("; }

template<class Type>
typename
    boost::enable_if< boost::mpl::or_< is_static_right_open<Type>
