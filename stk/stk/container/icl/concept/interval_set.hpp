...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_CONCEPT_INTERVAL_SET_HPP_JOFA_100920
#define STK_ICL_CONCEPT_INTERVAL_SET_HPP_JOFA_100920
...
//------------------------------------------------------------------------------
template<class Type>
typename boost::enable_if<is_interval_set<Type>, bool>::type
...
typename boost::enable_if<has_same_concept<is_interval_set, Type, OperandT>, 
                   bool>::type 
...
//------------------------------------------------------------------------------
template<class Type>
typename boost::enable_if<is_interval_set<Type>, Type>::type&
...
template<class Type>
inline typename boost::enable_if<is_interval_set<Type>, Type>::type&
...
//------------------------------------------------------------------------------
template<class Type>
inline typename boost::enable_if<is_interval_set<Type>, typename Type::iterator>::type
...
//------------------------------------------------------------------------------
template<class Type>
typename boost::enable_if<is_interval_set<Type>, void>::type
...
template<class Type, class OperandT>
typename boost::enable_if<is_concept_compatible<is_interval_set, Type, OperandT>, Type>::type&
...
typename boost::enable_if<is_interval_set<Type>, 
