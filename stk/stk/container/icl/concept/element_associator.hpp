...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_CONCEPT_ELEMENT_ASSOCIATOR_HPP_JOFA_100921
#define STK_ICL_CONCEPT_ELEMENT_ASSOCIATOR_HPP_JOFA_100921

#include <boost/config.hpp>
#include <stk/container/icl/type_traits/is_associative_element_container.hpp>
#include <stk/container/icl/type_traits/is_key_container_of.hpp>
#include <stk/container/icl/type_traits/is_combinable.hpp>
#include <stk/container/icl/detail/subset_comparer.hpp>
#include <stk/container/icl/concept/element_set.hpp>
#include <stk/container/icl/concept/element_map.hpp>
...
//==============================================================================
template<class Type>
typename boost::enable_if<is_element_container<Type>, std::size_t>::type
...
template<class Type>
typename boost::enable_if<is_associative_element_container<Type>, typename Type::size_type>::type
...
template<class Type>
typename boost::enable_if<is_associative_element_container<Type>, bool>::type
...
typename boost::enable_if<boost::mpl::and_< is_associative_element_container<SuperT>
...
template<class Type>
inline typename boost::enable_if<is_associative_element_container<Type>, bool>::type
...
//==============================================================================
template <class Type>
inline typename boost::enable_if<is_associative_element_container<Type>, Type>::type&
...
//------------------------------------------------------------------------------
template<class Type>
typename boost::enable_if<is_associative_element_container<Type>,
...
//------------------------------------------------------------------------------
template<class Type>
inline typename boost::enable_if<is_associative_element_container<Type>, void>::type
