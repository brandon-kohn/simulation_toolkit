...
+-----------------------------------------------------------------------------*/
#ifndef STK_ICL_CONCEPT_ELEMENT_SET_HPP_JOFA_100921
#define STK_ICL_CONCEPT_ELEMENT_SET_HPP_JOFA_100921

#include <stk/container/icl/type_traits/is_combinable.hpp>
#include <stk/container/icl/concept/set_value.hpp>
#include <stk/container/icl/detail/std_set.hpp>
...
template <class Type>
typename boost::enable_if<is_element_set<Type>, Type>::type&
...
template <class Type>
typename boost::enable_if<is_element_set<Type>, typename Type::iterator>::type
...
//==============================================================================
template<class Type>
inline typename boost::enable_if<is_element_set<Type>, bool>::type
...
//==============================================================================
template<class Type>
inline typename boost::enable_if<is_element_set<Type>, Type>::type&
...
inline typename boost::enable_if<is_element_set<Type>, std::basic_ostream<CharType, CharTraits> >::type&
