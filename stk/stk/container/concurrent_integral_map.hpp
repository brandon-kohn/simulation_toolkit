...
#include <stk/utility/deprecated.hpp>
...
namespace stk { namespace detail {
    ...
    class STK_DEPRECATED_MSG("concurrent_integral_map was deprecated in stk_1.3.0. Use concurrent_numeric_unordered_map or concurrent_pointer_unordered_map as your needs dictate.") concurrent_integral_map
    {
    public:
