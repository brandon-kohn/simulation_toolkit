...
REM Build the debug
cmake -H. -Bcmake.build.debug -DCMAKE_BUILD_TYPE=debug -DCMAKE_INSTALL_PREFIX="%INSTALL_PATH%" -G%CMAKE_GENERATOR% %ARCHITECTURE% -DFORCE_MSVC_RUNTIME="/MD" -DFORCE_MSVC_DEBUG_DEFINE="/DEBUG"
if ERRORLEVEL 1 goto error
